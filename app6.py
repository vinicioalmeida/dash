...
selected_tool = st.sidebar.radio(
    ...
    ["Calculadora de VPL", "Estrutura de Capital", "Dividendos vs JCP", "Títulos de Renda Fixa", "Black-Scholes-Merton", "Gregas de Opções", "Payoff de Opções", "Simulador de Monte Carlo"]
)
